 ...
 * <code>it.scinti.lfr.secpg.sqlinjection.service.impl.VendorLocalServiceImpl</code> and
...
public class VendorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.scinti.lfr.secpg.sqlinjection.service.impl.VendorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static it.scinti.lfr.secpg.sqlinjection.model.Vendor
	 ...
	 */
	public static java.util.List<it.scinti.lfr.secpg.sqlinjection.model.Vendor>
	...
	public static java.util.List<it.scinti.lfr.secpg.sqlinjection.model.Vendor>
		...
		return getService().getVendorsByUuidAndCompanyId(
	...
	public static java.util.List<it.scinti.lfr.secpg.sqlinjection.model.Vendor>
		...
		return getService().searchVendors(
	...
	private static ServiceTracker<VendorLocalService, VendorLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VendorLocalService.class);

		ServiceTracker<VendorLocalService, VendorLocalService> serviceTracker =
			new ServiceTracker<VendorLocalService, VendorLocalService>(
				bundle.getBundleContext(), VendorLocalService.class, null);
