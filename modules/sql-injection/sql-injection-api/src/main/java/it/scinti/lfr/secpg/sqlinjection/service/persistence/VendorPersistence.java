...
public interface VendorPersistence extends BasePersistence<Vendor> {
	 ...
	 */
	public java.util.List<Vendor> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Vendor>
			orderByComparator);
	 ...
	 * @return the range of matching vendors
	 */
	public java.util.List<Vendor> findByUuid_C(
	 ...
	 * @return the ordered range of matching vendors
	 */
	public java.util.List<Vendor> findByhwId(
	 ...
	 * @return the ordered range of matching vendors
	 */
	public java.util.List<Vendor> findByname(
	 ...
	 * @return the range of matching vendors
	 */
	public java.util.List<Vendor> findBydescription(
	 ...
	 * @return the range of matching vendors
	 */
	public java.util.List<Vendor> findBymetadata(
	 ...
	 * @return the range of matching vendors
	 */
	public java.util.List<Vendor> findBywebsite(
	 ...
	 * @return the matching vendors
	 */
	public java.util.List<Vendor> findByndm(
