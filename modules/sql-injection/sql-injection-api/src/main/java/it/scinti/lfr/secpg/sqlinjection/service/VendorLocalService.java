...
public interface VendorLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VendorLocalServiceUtil} to access the vendor local service. Add custom service methods to <code>it.scinti.lfr.secpg.sqlinjection.service.impl.VendorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
